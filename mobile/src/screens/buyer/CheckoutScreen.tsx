...
const CheckoutScreen = () => {
    ...
    const addresses = [
        { id: '1', type: 'Home', address: '123, Campus Street, University Area, Bangalore - 560001', city: 'Bangalore', state: 'Karnataka', zipcode: '560001' },
        { id: '2', type: 'Work', address: '456, Tech Park, Electronic City, Bangalore - 560100', city: 'Bangalore', state: 'Karnataka', zipcode: '560100' },
    ];
